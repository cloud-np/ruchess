...
// magics found by Volker Annuss and Niklas Fiekas
// http://talkchess.com/forum/viewtopic.php?t=64790
const ROOK_MAGICS: &[MagicEntry; Square::NUM] = &gen_entries!(
...
const BISHOP_MAGICS: &[MagicEntry; Square::NUM] = &gen_entries!(
...
const fn get_magic_index(magics: &[MagicEntry; Square::NUM], index_bits: usize, square: Square, blockers: BitBoard) -> usize {
